...
import gym
_current_gym_envs = gym.envs.registration.registry.keys()
_current_gym_envs = set(_current_gym_envs)
robohive_env_suite = set()

# Register Arms Suite
import robohive.envs.arms # noqa
robohive_arm_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_myobase_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_myochal_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_myodm_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_fm_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_hand_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_claw_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_multitask_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
...
robohive_quad_suite = set(gym.envs.registration.registry.keys())-robohive_env_suite-_current_gym_envs
